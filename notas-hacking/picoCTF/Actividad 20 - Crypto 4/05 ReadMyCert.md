...
```
fergll@FerGLl:/mnt/c/Users/ferch$ wget https://artifacts.picoctf.net/c/424/readmycert.csr
--2026-04-21 22:25:02--  https://artifacts.picoctf.net/c/424/readmycert.csr
...
2026-04-21 22:25:03 (146 MB/s) - ‘readmycert.csr’ saved [997/997]

fergll@FerGLl:/mnt/c/Users/ferch$ openssl req -in readmycert.csr -noout -text
Certificate Request:
    Data:
        Version: 1 (0x0)
    ...
    Signature Value:
        ...
        63:2f:97:b5
fergll@FerGLl:/mnt/c/Users/ferch$

```


Este connado lo que realiza es lo siguiente:

- `req`: Le dice a OpenSSL que vamos a trabajar con un "Request" (CSR).
    
- `-in`: Especifica el archivo de entrada.
    
- `-noout`: Evita que imprima la versión codificada de nuevo.
    
- `-text`: Traduce el archivo a texto legible para humanos.

Aquí dentro encontramos la bandera.
