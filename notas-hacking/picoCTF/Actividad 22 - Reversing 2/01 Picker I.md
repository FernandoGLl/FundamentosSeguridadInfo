...
This service can provide you with a random number, but can it do anything else? Connect to the program with netcat: `$ nc saturn.picoctf.net 62649` The program's source code can be downloaded [here](https://artifacts.picoctf.net/c/513/picker-I.py).
...
```
fergll@FerGLl:/mnt/c/Users/ferch/Documents$ cat picker-I.py
...
while(True):
  try:
    ...
    print(e)
    break
fergll@FerGLl:/mnt/c/Users/ferch/Documents$ nc saturn.picoctf.net 62649
...
- Se utilizo la herramienta de Cyberchef para decodificar de formato hexadecimal a ASSCI para obtenerlo de manera mas rápida.
